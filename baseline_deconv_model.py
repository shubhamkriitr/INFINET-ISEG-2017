...
def get_model (input_shape,
    ...
    with K.tf.device(unet_args["device"]):
        ...
        up6b = Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same')(conv5)
        conv6b = Conv2D(256, (3, 3), activation='relu', padding='same')(up6b)
        conv6b= Conv2D(256, (3, 3), activation='relu', padding='same')(conv6b)
        
        up6 = Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same')(conv6b)
...
print('-'*10,'baseline_deconvolutional_model.py loaded','-'*10)
