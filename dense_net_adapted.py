...
def get_model (input_shape,unet_args={"lrate":1e-4,"loss":dice_coef_loss,"device":"/gpu:0"}):
    ...
    with K.tf.device(unet_args["device"]):
        ...
        pool3 = _maxpooling_block(en3)
        
        en4 = encoder_block(pool3,64,64,64)
        ...
        pool3_2 = _maxpooling_block(en3_2)
        
        en4_2 = encoder_block(pool3_2,64,64,64)
        #BOTTLENECK
        bottleneck = _bottle_neck(en4,en4_2,64)
        
        #DECODERS
        dec4 = decoder_block(bottleneck,64,64,64)
        dec3 = concat_decoder_block(dec4,en3,en3_2,64,64,64,64)
