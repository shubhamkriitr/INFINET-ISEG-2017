...
#%%
    model_dict ={'0':[mf+'/Y6_axis0_fold1.h5'],
                 '1':[],
                 '2':[]}
    
    test_vol_dict = {'0':trf+'/AXIS_0/subject-1-axis-0.h5',
                     '1':trf+'/AXIS_1/subject-1-axis-1.h5',
                     '2':trf+'/AXIS_2/subject-1-axis-2.h5'}
    
#    main_run_test(model_dict,test_vol_dict)
#%%

    model_dict ={'0':[],
                 '1':[mf+'/Y6_axis1_fold1.h5'],
                 '2':[]}
